...
import { hunt, train, research, farm, craft, sell, trade, negotiate } from './Jobs/actions';
...
class Choices extends React.PureComponent {
  render() {
    const { housing, land, peopleAvailable, build, buildings, hunt, jobs, train, research, goods, farm, people, craft, gold, sell, trade, negotiate } = this.props;
...
export default connect(mapStateToProps, { build, hunt, train, research, farm, craft, sell, trade, negotiate })(Choices);
